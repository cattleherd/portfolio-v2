    ...
    >
      ...
      >
        ...
        <Box //Left side of nav (link items)
          ...
          paddingLeft={"50px"}
          paddingTop={"10px"} //hides link elements based on viewport
        >
          <Box margin={"12px"}>
          ...
          <Box margin={"12px"}>
            <NextLink href="https://github.com/cattleherd" passHref>
              Github
            </NextLink>
          </Box>
        </Box>
        ...
        <Box
          flex={1}
          align="right"
          marginTop={"15px"} //right side of nav (theme toggle and hamburger menu)
        >
          <ThemeToggle />
          <Box ml={2} display={{ base: "inline-block", md: "none" }}>
            ...
            <Menu isLazy id="hamburger-menu">
              ...
              <MenuList>
                ...
                <NextLink href="https://github.com/cattleherd">
